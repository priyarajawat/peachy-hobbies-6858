        ...
        <div>
            ...
            <Box sx={{width:"86%",margin:"auto"}}>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/luminosity/1646140576865-02aba1.jpeg" />
                    ...
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/supply/customer-app-supply/1643120136395-80523e.jpeg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Furniture Making,Upholstery Purifier</Text>
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1635829954373-d05590.jpeg" />
            ...
            <Box sx={{width:"86%",margin:"auto"}}> <Heading sx={{marginTop:"100px"}}>Appliances</Heading>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1640322586655-03f2a3.jpeg" />
                    ...
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/category_v2/category_c0667020.png" />
                    ...
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/category_v2/category_bbb8c690.png" />
           ...
           <br/><br/>
            ...
            <Heading sx={{marginTop:"100px"}}>Salon , Spa and Massage services</Heading>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1603078782132-dfcd55.jpeg" />
                    ...
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Salon for Men</Text>
                    <Text sx={{fontSize:"15px",paddingTop:"1px",fontFamily:"bold",color:"grey",cursor:"pointer"}}>Flat 100 Off</Text>
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1601893536279-77bf02.png" />
                    ...
                    <Box>
                        <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/supply/customer-app-supply/1606211470897-f4afbc.jpeg" />
           ...
           <br/><br/>
            ...
            <Box sx={{width:"86%",margin:"auto"}}>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1625159882387-9585c7.jpeg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Bathroom and Kitchen Cleaning</Text>
                  
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/luminosity/1632396793425-1a5418.jpeg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Full Home Cleaning</Text>
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1630420912606-2fffa6.jpeg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Sofa & Carpet Cleaning</Text>
                 
                    </Box>
                    <Box>
                        <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/luminosity/1631159612066-53b210.jpeg" />
           ...
           <br/><br/>
            ...
            <Box sx={{width:"86%",margin:"auto"}}>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1631883165804-025664.png" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Salon Live</Text>
                  
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1631883164057-dd5910.png" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Salon For Man Royale</Text>
                    </Box>
                    <Box>
                    <Image borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1631883164904-165c1e.png" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Spa Luxe</Text>
                    
                    </Box>
                    <Box>
                        <Image borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/images/growth/home-screen/1631883164502-08f9f6.png" />
           ...
           <br/><br/>
            ...
            <Box sx={{width:"86%",margin:"auto",paddingBottom:"5rem"}}>
                ...
                <SimpleGrid className="grid" columns={4} spacingX='40px'>
                    ...
                    <Box>
                    <Image  height={"158px"} width={"300px"} borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/home_screen/carpenter.jpg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}>Furniture Making,Upholstery Purifier</Text>
                  
                    </Box>
                    <Box>
                    <Image height={"158px"} borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/category_v2/category_a91b73d0.jpeg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}> Electricians</Text>
                    </Box>
                    <Box>
                    <Image height={"158px"} width={"300px"} borderRadius={"12px"}  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/home_screen/plumber.jpg" />
                    <Text sx={{fontSize:"19px",paddingTop:"27px",fontFamily:"bold",cursor:"pointer"}}> Plumbers</Text>
                    
                    </Box>
                    <Box>
                        <Image  height={"158px"} width={"300px"} borderRadius={"12px"} src="https://res.cloudinary.com/urbanclap/image/upload/q_auto,f_auto,fl_progressive:steep,w_532/t_high_res_category/categories/bigpictures/carpenter.jpg" />
